...
# Unit tests for Pipedrive::DealFieldsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DealFieldsApi' do
  before do
    # run before each test
    @instance = Pipedrive::DealFieldsApi.new
  end
  ...
  describe 'test an instance of DealFieldsApi' do
    it 'should create an instance of DealFieldsApi' do
      expect(@instance).to be_instance_of(Pipedrive::DealFieldsApi)
    end
  end

  # unit tests for deal_fields_delete
  # Delete multiple deal fields in bulk
  # Marks multiple fields as deleted.
  # @param ids Comma-separated field IDs to delete
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'deal_fields_delete test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for deal_fields_get
  # Get all deal fields
  # Returns data about all fields deals can have
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'deal_fields_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for deal_fields_id_delete
  # Delete a deal field
  # Marks a field as deleted.
  # @param id ID of the field to delete.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'deal_fields_id_delete test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for deal_fields_id_get
  # Get one deal field
  # Returns data about a specific deal field.
  # @param id ID of the field to fetch.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'deal_fields_id_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for deal_fields_id_put
  # Update a deal field
  ...
  # @return [nil]
  describe 'deal_fields_id_put test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for deal_fields_post
  ...
  # @return [nil]
  describe 'deal_fields_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
