...
# Unit tests for Pipedrive::ProductFieldsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductFieldsApi' do
  before do
    # run before each test
    @instance = Pipedrive::ProductFieldsApi.new
  end
  ...
  describe 'test an instance of ProductFieldsApi' do
    it 'should create an instance of ProductFieldsApi' do
      expect(@instance).to be_instance_of(Pipedrive::ProductFieldsApi)
    end
  end

  # unit tests for product_fields_delete
  # Delete multiple product fields in bulk
  # Marks multiple fields as deleted.
  # @param ids Comma-separated field IDs to delete
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'product_fields_delete test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for product_fields_get
  # Get all product fields
  # Returns data about all product fields
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'product_fields_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for product_fields_id_delete
  # Delete a product field
  # Marks a field as deleted.
  # @param id ID of the field to delete.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'product_fields_id_delete test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for product_fields_id_get
  # Get one product field
  # Returns data about a specific product field.
  # @param id ID of the field to fetch.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'product_fields_id_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for product_fields_id_put
  ...
  # @return [nil]
  describe 'product_fields_id_put test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for product_fields_post
  ...
  # @return [nil]
  describe 'product_fields_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
