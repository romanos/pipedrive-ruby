...
# Unit tests for Pipedrive::OrganizationFieldsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrganizationFieldsApi' do
  before do
    # run before each test
    @instance = Pipedrive::OrganizationFieldsApi.new
  end
  ...
  describe 'test an instance of OrganizationFieldsApi' do
    it 'should create an instance of OrganizationFieldsApi' do
      expect(@instance).to be_instance_of(Pipedrive::OrganizationFieldsApi)
    end
  end

  # unit tests for organization_fields_delete
  # Delete multiple organization fields in bulk
  # Marks multiple fields as deleted.
  # @param ids Comma-separated field IDs to delete
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'organization_fields_delete test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for organization_fields_get
  # Get all organization fields
  # Returns data about all organization fields
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'organization_fields_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for organization_fields_id_delete
  # Delete an organization field
  # Marks a field as deleted.
  # @param id ID of the field to delete.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'organization_fields_id_delete test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for organization_fields_id_get
  # Get one organization field
  # Returns data about a specific organization field.
  # @param id ID of the field to fetch.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'organization_fields_id_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for organization_fields_id_put
  ...
  # @return [nil]
  describe 'organization_fields_id_put test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for organization_fields_post
  ...
  # @return [nil]
  describe 'organization_fields_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
