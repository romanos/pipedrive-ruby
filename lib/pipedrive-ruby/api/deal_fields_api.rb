...
module Pipedrive
  class DealFieldsApi
    ...
    def deal_fields_id_delete_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = "/dealFields/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    # @return [nil]
    def deal_fields_post(name, field_type, opts = {})
      deal_fields_post_with_http_info(name, field_type, opts)
      end
    ...
    # @option opts [] :options When field_type is either set or enum, possible options must be supplied as a JSON-encoded sequential array, for example: [\&quot;red\&quot;,\&quot;blue\&quot;,\&quot;lilac\&quot;]
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def deal_fields_post_with_http_info(name, field_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DealFieldsApi.deal_fields_post ..."
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling DealFieldsApi.deal_fields_post"
      end
      # verify the required parameter 'field_type' is set
      if @api_client.config.client_side_validation && field_type.nil?
        fail ArgumentError, "Missing the required parameter 'field_type' when calling DealFieldsApi.deal_fields_post"
      end
      # resource path
      local_var_path = "/dealFields"
