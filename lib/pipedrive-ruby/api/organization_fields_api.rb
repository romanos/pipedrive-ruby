...
module Pipedrive
  class OrganizationFieldsApi
    ...
    # @return [nil]
    def organization_fields_delete(ids, opts = {})
      organization_fields_delete_with_http_info(ids, opts)
      return nil
    end
    ...
    def organization_fields_delete_with_http_info(ids, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrganizationFieldsApi.organization_fields_delete ..."
      end
      # verify the required parameter 'ids' is set
      if @api_client.config.client_side_validation && ids.nil?
        fail ArgumentError, "Missing the required parameter 'ids' when calling OrganizationFieldsApi.organization_fields_delete"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationFieldsApi#organization_fields_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def organization_fields_get(opts = {})
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def organization_fields_get_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def organization_fields_id_delete(id, opts = {})
      organization_fields_id_delete_with_http_info(id, opts)
      return nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def organization_fields_id_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrganizationFieldsApi.organization_fields_id_delete ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OrganizationFieldsApi.organization_fields_id_delete"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationFieldsApi#organization_fields_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def organization_fields_id_get(id, opts = {})
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def organization_fields_id_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
    ...
    # @return [nil]
    def organization_fields_id_put(id, name, opts = {})
      organization_fields_id_put_with_http_info(id, name, opts)
      return nil
    end
    ...
    # @option opts [] :options When field_type is either set or enum, possible options must be supplied as a JSON-encoded sequential array of objects. All active items must be supplied and already existing items must have their ID supplied. New items only require a label. Example: [{\&quot;id\&quot;:123,\&quot;label\&quot;:\&quot;Existing Item\&quot;},{\&quot;label\&quot;:\&quot;New Item\&quot;}]
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def organization_fields_id_put_with_http_info(id, name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrganizationFieldsApi.organization_fields_id_put ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OrganizationFieldsApi.organization_fields_id_put"
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling OrganizationFieldsApi.organization_fields_id_put"
      end
      # resource path
      local_var_path = "/organizationFields/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationFieldsApi#organization_fields_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [nil]
    def organization_fields_post(name, field_type, opts = {})
      organization_fields_post_with_http_info(name, field_type, opts)
      return nil
    end
    ...
    # @option opts [] :options When field_type is either set or enum, possible options must be supplied as a JSON-encoded sequential array, for example: [\&quot;red\&quot;,\&quot;blue\&quot;,\&quot;lilac\&quot;]
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def organization_fields_post_with_http_info(name, field_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrganizationFieldsApi.organization_fields_post ..."
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling OrganizationFieldsApi.organization_fields_post"
      end
      # verify the required parameter 'field_type' is set
      if @api_client.config.client_side_validation && field_type.nil?
        fail ArgumentError, "Missing the required parameter 'field_type' when calling OrganizationFieldsApi.organization_fields_post"
      end
      # resource path
      local_var_path = "/organizationFields"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationFieldsApi#organization_fields_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
